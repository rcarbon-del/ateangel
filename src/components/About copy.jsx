      ...
      <div className="w-5/6">
        ...
        <motion.div variants={fadeIn("", "", 0.1, 1)} className='flex flex-row justify-start items-center mt-5'>
            <a href='https://www.facebook.com/profile.php?id=61554100254498' target='_blank' rel="norefferer">
              <FontAwesomeIcon icon={faFacebook} className='text-secondary text-2xl mr-5 hover:animate-bounce' />
            </a>
            <a href='https://github.com/rcarbon-del' target='_blank' rel='noreferrer'>
              <FontAwesomeIcon icon={faGithub} className='text-secondary text-2xl mr-5 hover:animate-bounce' />
            </a>
            <a href='https://www.instagram.com/rcarbon.ig/' target='_blank' rel='noreferrer'>
              <FontAwesomeIcon icon={faInstagram} className='text-secondary text-2xl mr-5 hover:animate-bounce' />
            </a>
            <a href='https://twitter.com/rcarbontwt/' target='_blank' rel='noreferrer'>
              <FontAwesomeIcon icon={faTwitter} className='text-secondary text-2xl mr-5 hover:animate-bounce' />
            </a>
            <a href='https://www.linkedin.com/in/rcarbon/' target='_blank' rel='noreferrer'>
              <FontAwesomeIcon icon={faLinkedin} className='text-secondary text-2xl mr-5 hover:animate-bounce' />
            </a>
            <p className="text-secondary text-[17px] leading-[30px] mr-5" >|</p>
            <p><FontAwesomeIcon icon={faMap} className='text-secondary text-xl mr-2' /></p>
          ...
          <p><FontAwesomeIcon icon={faPhone} className='text-secondary text-xl mr-2' /></p>
          <p className="text-secondary text-[17px] leading-[30px] mr-5" >09760304353</p>
          <p><FontAwesomeIcon icon={faMailBulk} className='text-secondary text-xl mr-2' /></p>
          <p className="text-secondary text-[17px] leading-[30px] mr-5" >contact@rcarbon.me</p>
          <a href='https://uc-bcf.edu.ph'target='_blank' className="flex"><FontAwesomeIcon icon={faEarth} className='text-secondary text-xl mr-2' />
